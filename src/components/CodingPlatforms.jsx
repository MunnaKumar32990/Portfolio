...
const platformImages = {
  ...
  spoj: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.andreafiori.net%2Fsoftware-development%2Fcompetitive-programming&psig=AOvVaw3K97IpN7YxVG_6Y7SmZk3V&ust=1756131768390000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCPCt_-DSo48DFQAAAAAdAAAAABAE",
};
...
const CodingPlatforms = () => {
  ...
  const codingPlatforms = personalData.codingPlatforms.map(platform => ({
    ...platform,
    ...platformExtras[platform.name]
  }));

  return (
    <section className="py-16 md:py-24 bg-white" id="coding-platforms">
      <div className="container mx-auto px-8 sm:px-8 max-w-screen-2xl h-[500px] md:h-[700px] lg:h-screen">
        <motion.div
          ref={ref}
